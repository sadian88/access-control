...
export type WsEvent =
  ...
  | { type: 'pending_approval'; pending_id: string; person: { id: string; full_name: string; apartment: string | null; person_type: string; photo_path: string | null }; event_type: string; message: string; duration: string | null; photo_url: string | null; timestamp: string; visitor_card_number?: string | null; belongs_to?: string | null }
